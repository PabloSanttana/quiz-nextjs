...
const questoes: QuestionModel[] = [
  ...
  new QuestionModel(
    ...
    [
      ...
      AnswerModel.certain("Monte Everest"),
    ]
  ),
  ...
  new QuestionModel(214, "A compensação por perda é chamada de...", [
    ...
    AnswerModel.certain("Indenização"),
  ]),
  new QuestionModel(
    215,
    ...
    [
      ...
      AnswerModel.certain("Saci-pererê"),
    ]
  ),
  new QuestionModel(216, 'Quem é o "patrono" do Exército Brasileiro?', [
    ...
    AnswerModel.certain("Duque de Caxias"),
  ]),
];
